...
from fake_stake.base_test import CashCash_FakeStakeTest

class zCSBITValidCoinSpendTest(CashCash_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCSBITs..." % DENOM_TO_USE)
