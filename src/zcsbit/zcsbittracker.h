...
#ifndef CashCash_ZCSBITTRACKER_H
#define CashCash_ZCSBITTRACKER_H
...
public:
    CzCSBITTracker(std::string strWalletFile);
    ~CzCSBITTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCSBITWallet* zCSBITWallet = NULL);
...
#endif //CashCash_ZCSBITTRACKER_H
