...
#ifndef CashCash_ZCSBITWALLET_H
#define CashCash_ZCSBITWALLET_H
...
public:
    CzCSBITWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCSBIT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCSBIT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
