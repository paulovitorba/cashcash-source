...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "cashcash" is a composite category enabling all CashCash-related debug output
            if (ptrCategory->count(string("cashcash"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "cashcash.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "cashcashd.pid"));
