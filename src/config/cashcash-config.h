/* src/config/cashcash-config.h.  Generated from cashcash-config.h.in by configure.  */
/* src/config/cashcash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CSBIT_CONFIG_H

#define CSBIT_CONFIG_H
