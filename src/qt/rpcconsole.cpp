                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCSBITPathCustom = GetArg("-zcsbitbackuppath", "");
    ...
    if(!strzCSBITPathCustom.empty()) {
        ui->wallet_customzcsbitbackuppath->setText(QString::fromStdString(strzCSBITPathCustom));
        ui->wallet_customzcsbitbackuppath_label->setVisible(true);
        ui->wallet_customzcsbitbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCSBITPathCustom.empty()) && nCustomBackupThreshold > 0) {
