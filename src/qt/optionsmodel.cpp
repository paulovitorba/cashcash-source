...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::CSBIT);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeCashCashAmount"))
        SoftSetArg("-anonymizecashcashamount", settings.value("nAnonymizeCashCashAmount").toString().toStdString());
