...
extern UniValue DoZcsbitSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzcsbitseed(const UniValue& params, bool fHelp);
extern UniValue getzcsbitseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcsbit(const UniValue& params, bool fHelp);
extern UniValue dzcsbitstate(const UniValue& params, bool fHelp);
