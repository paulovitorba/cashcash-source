...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CashCash features */
        {"cashcash", "listmasternodes", &listmasternodes, true, true, false},
        {"cashcash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cashcash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cashcash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cashcash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cashcash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cashcash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cashcash", "masternodedebug", &masternodedebug, true, true, false},
        {"cashcash", "startmasternode", &startmasternode, true, true, false},
        {"cashcash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cashcash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cashcash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cashcash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cashcash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cashcash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cashcash", "preparebudget", &preparebudget, true, true, false},
        {"cashcash", "submitbudget", &submitbudget, true, true, false},
        {"cashcash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cashcash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cashcash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cashcash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cashcash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cashcash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cashcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cashcash", "checkbudgets", &checkbudgets, true, true, false},
        {"cashcash", "mnsync", &mnsync, true, true, false},
        {"cashcash", "spork", &spork, true, true, false},
        {"cashcash", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcsbitseed", &getzcsbitseed, false, false, true},
        {"zerocoin", "setzcsbitseed", &setzcsbitseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcsbit", &searchdzcsbit, false, false, true},
        {"zerocoin", "dzcsbitstate", &dzcsbitstate, false, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33025/\n";
}
